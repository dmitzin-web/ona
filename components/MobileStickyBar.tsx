...
export function MobileStickyBar() {
  return (
    <div
      ...
      className="fixed inset-x-0 bottom-0 z-30 border-t border-line-light/50 bg-ivory/50 px-3 py-1.5 backdrop-blur-md lg:hidden"
    ...
    >
      <div className="grid grid-cols-2 gap-2">
        ...
        <Link
          href="/start-project"
          className="flex items-center justify-center gap-1.5 rounded-full bg-warm-gray-soft/60 py-2 text-[12px] font-medium text-charcoal transition active:bg-charcoal active:text-ivory"
        >

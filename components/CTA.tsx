    ...
    <section className="relative bg-charcoal text-ivory">
      <div className="mx-auto grid max-w-7xl gap-12 px-6 py-24 lg:grid-cols-12 lg:px-10">
        ...
        <div className="flex flex-col gap-4 lg:col-span-5 lg:items-end lg:justify-end">
          <PhoneLink className="inline-flex items-center justify-center gap-3 border border-ivory bg-ivory px-8 py-4 text-sm font-medium uppercase tracking-[0.22em] text-charcoal transition hover:bg-transparent hover:text-ivory">

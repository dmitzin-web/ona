  ...
  return (
    <div className="bg-charcoal text-ivory">
      <div className="mx-auto max-w-2xl px-6 py-16 md:py-24 lg:px-10">
        ...
        <div className="mt-16 flex items-center justify-between border-t border-ivory/10 pt-6">
          <button
            type="button"
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        <div className="text-[16px] font-medium text-ivory">{label}</div>
        <span
          className={[
            "h-3 w-3 rounded-full border",
            isOn ? "border-gold bg-gold" : "border-ivory/10",
          ].join(" ")}
        />
      </div>

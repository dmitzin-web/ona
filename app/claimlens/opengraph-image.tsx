...
// ClaimLens™ Open Graph image (1200x630). Shared when /claimlens or any
...
export const alt = "ClaimLens™ — AI insurance estimate review";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

export default function ClaimLensOpenGraphImage() {

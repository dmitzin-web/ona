  ...
  return (
    <section className="bg-ivory">
      <div className="mx-auto max-w-3xl px-6 py-32 text-center lg:px-10">
        <p className="eyebrow text-charcoal/60">Quote request received</p>
        ...
        <div className="mt-12 flex flex-wrap justify-center gap-4">
          <PhoneLink className="inline-flex items-center gap-3 border border-charcoal bg-charcoal px-7 py-4 text-sm font-medium uppercase tracking-[0.22em] text-ivory transition hover:bg-transparent hover:text-charcoal">
            <PhoneIcon className="h-4 w-4 stroke-current" />
            {site.phoneDisplay}
          </PhoneLink>
          <Link
            href="/"
            className="inline-flex items-center gap-3 border border-charcoal/30 px-7 py-4 text-sm font-medium uppercase tracking-[0.22em] text-charcoal transition hover:border-charcoal"
          >
            Back home
          </Link>
        </div>

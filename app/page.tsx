    ...
    <>
        ...
        <div className="mx-auto max-w-7xl px-6 pt-20 pb-20 md:pt-28 md:pb-24 lg:px-10">
          <div className="grid gap-12 md:grid-cols-[1.05fr_1fr] md:items-center md:gap-16">
            <div>
              ...
              <h1 className="mt-8 text-[40px] font-semibold leading-[1.04] tracking-[-0.025em] text-charcoal md:text-[64px]">
                Restoration &amp; remodeling{" "}
                <span className="text-warm-gray-deep">
                  without the chaos.
                </span>
              </h1>

              <p className="mt-8 max-w-xl text-[17px] leading-relaxed text-warm-gray-deep md:text-[18px]">
            ...
            <div className="relative aspect-[4/5] overflow-hidden rounded-2xl border border-line-light shadow-[0_1px_0_rgba(0,0,0,0.02),0_30px_70px_-30px_rgba(0,0,0,0.25)]">
              <Image
                src={photos[0].src}
              ...
              <div className="absolute bottom-4 left-4 right-4 rounded-xl border border-white/15 bg-charcoal/80 p-4 text-ivory shadow-[0_20px_50px_-20px_rgba(0,0,0,0.55)] backdrop-blur-md sm:bottom-5 sm:left-5 sm:right-5">
                ...
                <div className="mt-2 h-1 w-full overflow-hidden rounded-full bg-ivory/15">
                  <div
            ...
            {[
              ...
              <div key={item.title} className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="mt-1 text-[13px] text-warm-gray-deep">
                    {item.hint}
                  </div>
                </div>
              </div>
      ...
      <section className="border-t border-line-light bg-ivory">
        <div className="mx-auto max-w-7xl px-6 py-24 md:py-32 lg:px-10">
          <p className="eyebrow text-warm-gray-deep">What we do</p>
          <h2 className="mt-6 max-w-3xl text-[32px] font-semibold leading-[1.1] tracking-[-0.02em] text-charcoal md:text-[44px]">
          ...
          <div className="mt-16 grid gap-12 md:grid-cols-2 md:gap-20">
            <div>
              <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-3">
                  ...
                  <p className="eyebrow text-warm-gray-deep">Restoration</p>
                </div>
                <span className="text-[10px] uppercase tracking-[0.18em] text-gold-deep">
                  Available now · 24/7
                </span>
              </div>
              <p className="mt-4 text-[18px] leading-relaxed text-charcoal">
              ...
              <ul className="mt-8 grid gap-3 text-[15px] text-warm-gray-deep">
                {services
                  .filter((s) => s.slug !== "remodeling")
                  .map((s) => (
                    <li
                      key={s.slug}
                      className="border-t border-line-light pt-3"
                    >
                      <Link
                        href={`/services/${s.slug}`}
                        className="flex items-center justify-between transition hover:text-charcoal"
                      >
              ...
              <div className="mt-10 rounded-xl border border-line-light bg-ivory-soft p-5">
                <p className="eyebrow text-warm-gray-deep">When you call</p>
                <ol className="mt-3 space-y-2 text-[13px] text-warm-gray-deep">
                  <li className="flex gap-3">
                    <span className="font-medium text-charcoal">1.</span>
                    <span>Answered in person — triage on the call.</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="font-medium text-charcoal">2.</span>
                    <span>On-site within 25 min for most of Clark Co.</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="font-medium text-charcoal">3.</span>
                    <span>Walk-through, moisture readings, photos.</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="font-medium text-charcoal">4.</span>
            ...
            <div className="md:border-l md:border-line-light md:pl-16">
              <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-3">
                  <span className="h-2 w-2 rounded-full bg-gold-deep" />
                  <p className="eyebrow text-warm-gray-deep">Remodeling</p>
                </div>
                <span className="text-[10px] uppercase tracking-[0.18em] text-warm-gray-deep">
                  Booking · June
                </span>
              </div>
              <p className="mt-4 text-[18px] leading-relaxed text-charcoal">
              ...
              <div className="mt-10 rounded-xl border border-line-light bg-ivory-soft p-5">
                <p className="eyebrow text-warm-gray-deep">How we build</p>
                <ul className="mt-3 grid gap-2 text-[13px] text-warm-gray-deep">
                  <li>
                  ...
                  <li>
                    <span className="text-charcoal">Fit —</span> we measure
                    twice, use shims like surgeons, and don&apos;t
                    caulk-over imperfect cuts.
                  </li>
                  <li>
                    <span className="text-charcoal">Finish —</span> photos
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 md:py-20 lg:px-10">
          <div className="grid gap-10 md:grid-cols-[1fr_1.6fr] md:gap-16">
            <div>
              ...
              <h2 className="mt-5 text-[26px] font-semibold leading-[1.15] tracking-[-0.015em] text-charcoal md:text-[32px]">
                What an organized restoration log
                <span className="text-warm-gray-deep">
                  {" "}actually looks like.
                </span>
              </h2>
              <p className="mt-5 text-[14px] leading-relaxed text-warm-gray-deep">
            ...
            <div className="rounded-2xl border border-line-light bg-ivory">
              <div className="flex items-center justify-between border-b border-line-light px-5 py-3 text-[11px] uppercase tracking-[0.22em] text-warm-gray-deep">
              ...
              <dl className="divide-y divide-line-light text-[13px]">
                {[
                  {
                    label: "Moisture map",
                    value: "14% → 12% → 9% → 7%",
                  ...
                  >
                    <dt className="text-[11px] uppercase tracking-[0.18em] text-warm-gray-deep">
                      {row.label}
                    </dt>
                    <dd className="font-mono text-[13px] tabular-nums text-charcoal">
                      {row.value}
                    </dd>
                    <dd className="text-[12px] text-warm-gray-deep sm:text-right">
                      {row.note}
                    </dd>
                  </div>
                ))}
      ...
      <section className="border-t border-line-light bg-ivory-soft">
        <div className="mx-auto max-w-7xl px-6 py-24 md:py-32 lg:px-10">
          ...
          <p className="mt-6 max-w-2xl text-[17px] leading-relaxed text-warm-gray-deep md:text-[18px]">
          ...
          {/* Desktop mockup — stronger shadow + hover affordance
              ...
              static wireframe. */}
          <div className="mt-12 overflow-hidden rounded-2xl border border-line-light bg-ivory shadow-[0_1px_0_rgba(0,0,0,0.02),0_40px_80px_-30px_rgba(20,20,20,0.28)]">
            <div className="flex items-center gap-2 border-b border-line-light bg-ivory-soft px-4 py-3">
              <div className="flex gap-1.5">
                <span className="h-2.5 w-2.5 rounded-full bg-line-light" />
                <span className="h-2.5 w-2.5 rounded-full bg-line-light" />
                <span className="h-2.5 w-2.5 rounded-full bg-line-light" />
              </div>
              <div className="ml-3 rounded-md border border-line-light bg-ivory px-3 py-1 text-[12px] text-warm-gray-deep">
                onarestore.com/work/sample
              </div>
              <div className="ml-auto rounded-full bg-gold-soft px-2.5 py-1 text-[11px] font-medium text-gold-deep">
                SAMPLE
              </div>
            </div>
            ...
            <div className="p-6 md:p-10">
              <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                <div>
                  ...
                  <h3 className="mt-3 text-[24px] font-semibold leading-tight tracking-tight text-charcoal md:text-[28px]">
                    NE Hazel Dell — kitchen leak rebuild
                  </h3>
                  <p className="mt-2 text-[13px] text-warm-gray-deep">
                    Opened May 18 · Day 7 of 14 · Adjuster: Liberty Mutual
                  </p>
                </div>
                <div className="inline-flex items-center gap-2 self-start rounded-full border border-gold/40 bg-gold/5 px-3 py-1.5 text-[12px] text-gold-deep">
                  <span className="ona-pulse h-1.5 w-1.5 rounded-full bg-gold" />
                  3 new updates today
                </div>
              </div>
              ...
              {/* Phase progress bar */}
              <div className="mt-8 rounded-xl border border-line-light bg-ivory-soft p-5">
                <div className="flex items-center justify-between text-[12px]">
                  <span className="text-warm-gray-deep">Day 7 of est. 14</span>
                  <span className="font-medium text-charcoal">
                    50% complete · on schedule
                  </span>
                </div>
                <div className="mt-3 h-2 w-full overflow-hidden rounded-full bg-line-light">
                  <div
                      ...
                      <span
                        className={
                          p.state === "done"
                            ...
                            : p.state === "now"
                              ? "ona-pulse inline-block h-3.5 w-3.5 flex-none rounded-full border-2 border-gold bg-ivory"
                              : "inline-block h-3.5 w-3.5 flex-none rounded-full border border-line-light bg-ivory"
                        }
                      >
                        {p.state === "done" ? "✓" : ""}
                      </span>
              ...
              <div className="mt-8 grid gap-8 md:grid-cols-[1.4fr_1fr]">
                <div>
                  ...
                  <div className="mt-5 space-y-5">
                    {[
                      ...
                      <div
                        key={entry.day}
                        className="grid cursor-pointer gap-3 border-t border-line-light pt-4 transition hover:bg-ivory-soft/40 sm:grid-cols-[80px_1fr]"
                      >
                        <div>
                          <div className="text-[12px] uppercase tracking-[0.18em] text-warm-gray-deep">
                            {entry.day}
                            {entry.isNow ? (
                              <span className="ml-1.5 inline-block h-1.5 w-1.5 rounded-full bg-gold align-middle" />
                            ) : null}
                          </div>
                          <div className="mt-1 text-[10px] tabular-nums text-warm-gray">
                            {entry.ts}
                          </div>
                        </div>
                        <div>
                          ...
                          <div className="mt-1 text-[14px] leading-relaxed text-warm-gray-deep">
                            {entry.body}
                          </div>
                          <div className="mt-2 flex items-center gap-2 text-[11px] text-warm-gray">
                ...
                <aside className="space-y-6 md:border-l md:border-line-light md:pl-8">
                  <div>
                    <div className="eyebrow text-warm-gray-deep">
                      Approved scope
                    </div>
                    <div className="mt-2 text-[24px] font-semibold tabular-nums text-charcoal">
                      $14,820
                    </div>
                    <div className="mt-1 text-[12px] text-warm-gray-deep">
                          ...
                          <span
                            className={
                              m.state === "done"
                                ...
                                : m.state === "now"
                                  ? "ona-pulse inline-block h-4 w-4 flex-none rounded-full border-2 border-gold bg-ivory"
                                  : "inline-block h-4 w-4 flex-none rounded-full border border-line-light bg-ivory"
                            }
                          >
                            {m.state === "done" ? "✓" : ""}
                          </span>
                  ...
                  <div>
                    ...
                    <div className="mt-3 grid grid-cols-4 gap-1.5">
                      {photos.slice(0, 8).map((p) => (
                        <div
                          key={p.src}
                          className="relative aspect-square overflow-hidden rounded-md border border-line-light bg-ivory-soft"
                        >
                          <Image
                            src={p.src}
                            alt={p.alt}
                    ...
                    <div className="mt-3 text-[12px] text-warm-gray-deep">
                  ...
                  <div>
                    ...
                    <ul className="mt-3 space-y-2 text-[13px]">
                      {[
                        ...
                        <li
                          key={d.name}
                          className="flex items-center gap-3 rounded-md border border-line-light bg-ivory-soft/50 p-2.5 transition hover:border-warm-gray-soft hover:bg-ivory-soft"
                        >
                  ...
                  <div>
                    ...
                    <ul className="mt-3 space-y-2 text-[12px] text-warm-gray-deep">
                      <li className="flex gap-2">
                        <span className="mt-1 inline-block h-1 w-1 flex-none rounded-full bg-gold" />
                        <span>
                          <span className="text-charcoal">Dmitry</span>{" "}
          ...
          <div className="mt-12 grid items-center gap-10 md:grid-cols-[1fr_auto] md:gap-16">
            <div className="max-w-lg">
              ...
              <h3 className="mt-4 text-[24px] font-semibold leading-tight tracking-tight text-charcoal md:text-[30px]">
            ...
            <div className="mx-auto w-[260px] flex-none rounded-[36px] border border-line-light bg-charcoal p-2 shadow-[0_30px_80px_-30px_rgba(0,0,0,0.35)] sm:w-[280px]">
              <div className="overflow-hidden rounded-[28px] bg-ivory">
                <div className="flex h-6 items-center justify-center bg-ivory">
                  <span className="h-1 w-12 rounded-full bg-charcoal/15" />
                </div>
                <div className="space-y-4 px-4 pb-5">
                  <div className="flex items-center justify-between text-[10px] text-warm-gray-deep">
                    <span>ONA</span>
                    <span>9:41</span>
                  </div>

                  <div>
                    <p className="text-[10px] uppercase tracking-wider text-warm-gray-deep">
                      Your project
                    </p>
                    <h4 className="mt-1 text-[14px] font-semibold leading-tight text-charcoal">
                      Kitchen leak rebuild
                    </h4>
                  </div>

                  <div className="flex items-center gap-2 rounded-lg bg-ivory-soft px-3 py-2">
                    <span className="ona-pulse h-1.5 w-1.5 rounded-full bg-gold" />
                    <span className="text-[11px] font-medium text-charcoal">
                      On schedule · Day 7 / 14
                    </span>
                  </div>
                  <div className="h-1.5 w-full rounded-full bg-line-light">
                    <div
                  ...
                  <div className="space-y-2.5">
                    {[
                      ...
                      <div
                        key={feed.title}
                        className="flex items-center gap-3 rounded-lg border border-line-light p-2"
                      >
                        ...
                        <div className="min-w-0">
                          <div className="truncate text-[11px] font-medium text-charcoal">
                            {feed.title}
                          </div>
                          <div className="truncate text-[10px] text-warm-gray-deep">
                            {feed.meta}
                          </div>
                        </div>
                      </div>
          ...
          <div className="mt-12">
            <Link
              href="/work/sample"
              className="inline-flex items-center gap-2 text-[14px] text-charcoal underline-offset-4 hover:underline"
            >
      ...
      <section className="border-t border-line-light bg-ivory">
        <div className="mx-auto max-w-7xl px-6 py-24 md:py-32 lg:px-10">
          <p className="eyebrow text-warm-gray-deep">How we charge</p>
          <h2 className="mt-6 max-w-3xl text-[32px] font-semibold leading-[1.1] tracking-[-0.02em] text-charcoal md:text-[44px]">
          ...
          <div className="mt-14 grid gap-12 md:grid-cols-2 md:gap-16">
            <div>
              ...
              <ul className="mt-6 space-y-3 text-[14px] text-warm-gray-deep">
                {[
                  "No upfront deposit",
                  ...
                  <li
                    key={line}
                    className="flex items-start gap-3 border-t border-line-light pt-3"
                  >
                    <span
                      aria-hidden
            ...
            <div className="md:border-l md:border-line-light md:pl-16">
              <p className="eyebrow text-warm-gray-deep">Remodel</p>
              <p className="mt-4 text-[17px] leading-relaxed text-charcoal">
              ...
              <div className="mt-8 rounded-xl border border-line-light bg-ivory-soft p-5">
                <div className="relative pt-2">
                  <div className="absolute left-3 right-3 top-[18px] h-px bg-line-light" />
                    ...
                    {[
                      ...
                      >
                        <span
                          className={
                            node.state === "start"
                              ? "h-3 w-3 rounded-full border-2 border-charcoal bg-ivory"
                              : node.state === "end"
                                ? "inline-flex h-3 w-3 items-center justify-center rounded-full bg-charcoal text-[8px] font-bold text-ivory"
                                : "h-3 w-3 rounded-full border-2 border-gold bg-ivory"
                          }
                        >
                          {node.state === "end" ? "✓" : null}
                        </span>
                        ...
                        {node.pct ? (
                          <span className="text-[12px] font-semibold tabular-nums text-gold-deep">
                            {node.pct}
                          </span>
                        ) : (
                ...
                <p className="mt-5 text-[12px] text-warm-gray-deep">
              ...
              <div className="mt-4 space-y-3">
                {[
                  ...
                  <div
                    key={phase.n}
                    className="grid items-center gap-4 rounded-xl border border-line-light bg-ivory-soft p-4 sm:grid-cols-[36px_1fr_auto]"
                  >
                    <div className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-charcoal text-[14px] font-semibold text-charcoal">
                      {phase.n}
                    </div>
                    <div>
                      <div className="text-[15px] font-medium text-charcoal">
                    ...
                    <div className="text-[14px] font-medium tabular-nums text-gold-deep sm:text-right">
                      {phase.pct}
                    </div>
                  </div>
                ))}
      ...
      <section className="border-t border-line-light bg-ivory">
        <div className="mx-auto max-w-7xl px-6 py-24 md:py-32 lg:px-10">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
            ...
            <p className="max-w-sm text-[14px] text-warm-gray-deep">
          ...
          <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <article
                key={i}
                className="overflow-hidden rounded-xl border border-line-light bg-ivory-soft"
              >
                <div className="relative aspect-[4/5] bg-ivory-soft">
                  <Image
                    src={card.photo.src}
                    alt={card.photo.alt}
                    fill
                ...
                <div className="flex flex-col gap-2 p-5">
                  ...
                  <div className="text-[16px] font-semibold leading-tight tracking-tight text-charcoal">
                    {card.title}
                  </div>
                  <div className="text-[12px] text-warm-gray-deep">
                    {card.meta}
                  </div>
                </div>
              </article>
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 md:py-28 lg:px-10">
          <div className="grid gap-12 md:grid-cols-[1fr_1.4fr] md:gap-20">
            <div>
              ...
              <h2 className="mt-6 text-[32px] font-semibold leading-[1.1] tracking-[-0.02em] text-charcoal md:text-[40px]">
                A small operation, on purpose.
              </h2>
              <p className="mt-6 text-[15px] leading-relaxed text-warm-gray-deep">
                Owner-operated. No project managers passing your job
                between subcontractors. No call centers.
              </p>
            </div>

            <div className="text-[17px] leading-relaxed text-charcoal">
              <p>
              ...
              <div className="mt-8 rounded-xl border border-line-light bg-ivory p-5">
                <p className="eyebrow text-warm-gray-deep">
                  ...
                  {[
                    ...
                    <li key={step.n} className="flex gap-3 text-[13px]">
                      ...
                      <div>
                        ...
                        <div className="text-warm-gray-deep">{step.body}</div>
                      </div>
                    </li>
                  ))}
                </ol>
              ...
              <p className="mt-8 text-[14px] text-warm-gray-deep">
      ...
      <section className="border-t border-line-light bg-ivory">
        <div className="mx-auto max-w-7xl px-6 py-24 md:py-32 lg:px-10">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
            <div>
              <p className="eyebrow text-warm-gray-deep">Real work</p>
              <h2 className="mt-6 max-w-2xl text-[32px] font-semibold leading-[1.1] tracking-[-0.02em] text-charcoal md:text-[40px]">
                First projects in progress. Photos posted as work completes.
              </h2>
            </div>
            <Link
              href="/blog"
              className="text-[14px] text-charcoal underline-offset-4 hover:underline"
            >
            ...
            {[
              ...
              >
                {card.photo ? (
                        ...
                        <span
                          className={
                            card.signal.live
                              ...
                              : "h-1.5 w-1.5 rounded-full bg-ivory/60"
                          }
                        />
                  ...
                  <div className="flex aspect-[16/10] items-center justify-center bg-ivory-soft">
                    <span className="rounded-full border border-dashed border-warm-gray-deep px-4 py-2 text-[11px] uppercase tracking-[0.22em] text-warm-gray-deep">
                      Available
                    </span>
                  </div>
                )}
                <div className="flex flex-col gap-3 p-5">
                  ...
                  <div className="text-[18px] font-semibold leading-tight tracking-tight text-charcoal">
                    {card.title}
                  </div>
                  <div className="text-[13px] text-warm-gray-deep">
                    {card.meta}
                  </div>
                </div>
              </div>
      ...
      {/* ─── 7. CLOSING CTA — dark anchor ─────────────────────
          The page has spent its full length in warm light tones.
          The closing section drops to charcoal: deeper material
          contrast, signature finish, the moment the eye stops.
          Same copy intent, same two CTAs — just on a calmer,
          heavier surface that anchors the bottom of the page. */}
          ...
          <div className="grid gap-12 md:grid-cols-[1.2fr_1fr] md:items-end md:gap-20">
            <div>
              ...
              <div className="mt-10 flex flex-col gap-3 sm:flex-row">
                ...
                <Link
                  href="/start-project"
                  className="inline-flex items-center justify-center rounded-full border border-ivory/30 bg-transparent px-7 py-3.5 text-[14px] font-medium text-ivory transition hover:border-ivory hover:bg-ivory hover:text-charcoal"
                >
                  Start a project
                </Link>
              </div>
            ...
            {/* Right column — a small calm grid of operational
                facts. Three lines, dark surface. Adds finish
                without inflating the section. */}
            <dl className="grid grid-cols-2 gap-6 border-t border-ivory/15 pt-8 text-[13px] md:border-l md:border-t-0 md:pl-10 md:pt-0">
              <div>
                <dt className="text-[10px] uppercase tracking-[0.22em] text-ivory/45">
                  Phone
                </dt>
